...
$(document).ready(function(){
  $("button").click(function(){
    $.get("https://api.exchangeratesapi.io/latest?symbols=USD,GBP", function(data, status){
      alert("Data: " + data + "\nStatus: " + status);
    });
  });
});
...
$(document).ready(function(){
 ...
 currency2=currencyCodes[$("input[name='country2']").val().toUpperCase()];
    $.get("https://api.exchangeratesapi.io/latest?symbols="+currency1+","+currency2, function(data, status){
